        ...
        <div className="w-auto flex flex-col gap-4 items-center">
            <h1 className="text-xl font-bold">Projects</h1>
                <div className="flex flex-col gap-1 text-sm items-center ">
                    ...
                    <Link href="https://strokeml.vercel.app"><div className="rounded-full hover:scale-110 hover:text-center hover:font-bold hover:cursor-pointer">S T R O K E &nbsp; A P P</div></Link>
                </div>
        </div>
    );
}
