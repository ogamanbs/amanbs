    ...
    return (
        <div className="md:h-[60vh] w-full flex flex-col md:flex-row items-center mt-32">
            <div className="hidden md:block h-full w-full md:w-[50%] p-5 md:p-10 mt-10 md:mt-0">
                <div className="h-full w-full border border-zinc-800 rounded-[20px] overflow-hidden bg-white/10">
            ...
            <div className="h-auto md:h-full w-full md:w-[50%] px-5 flex flex-col justify-center">
                <h1 className={`text-6xl md:text-9xl ${bebas_Neue.className} text-red-600`}>Heart Stroke Prediction App</h1>
                <div className="block md:hidden h-full w-full border border-zinc-800 rounded-[20px] overflow-hidden bg-white/10 mb-5 mt-3">
                    <Image className="h-full w-full object-contain" src={'/strokeml.png'} alt={"Stroke Prediction App"} width={1440} height={1440} />
                </div>
                <div className="">
                    This is a Heart Stroke prediction app which is developed using flask and react where the dataset to train the model was picked up from kaggle.
