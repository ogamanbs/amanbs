...
const Footer = () => {
    return (
        <div className="relative px-2 py-4 z-10 overflow-y-hidden">
            <div className="mt-20 h-full w-full flex flex-col md:flex-row justify-around items-center gap-10 md:gap-32 p-10 border border-zinc-700 rounded-[30px] mb-3 text-zinc-300 bg-black/10 z-10 backdrop-blur-lg">
                <Logo />
                <ProjectLinks />
                <Skills />
                <SocialLinks />
