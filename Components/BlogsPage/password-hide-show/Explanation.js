...
const Explanation = () => {
    return (
        ...
        <a href="#react-app-setup"><h1 id="rect-app-setup" className="text-xl mt-3 mb-3">Step 1: React App Setup</h1></a>
        <p className="">First, Make a directory and name it  &#34;<span className="text-lime-300">react-project</span>&#34;</p>
        <p className="">Then, create React app, using following command:</p>
        ...
        <a href="#react-app-setup"><h1 id="rect-app-setup" className="text-xl mt-3 mb-3">Step 2:</h1></a>
        </div>
    )
}
