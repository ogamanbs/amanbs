...
export default function AboutPage() {
    return (
        <div className="w-full min-h-screen bg-black text-white">
            <div className="px-10 py-5 flex justify-center md:justify-start">
            ...
            <div className="px-10 mt-10 md:mt-20 flex flex-col">
                <h1 className="text-red-400/50 md:text-red-400/20 text-center text-[10vw] font-extrabold leading-[50px] sm:leading-[90px] md:leading-[140px]"> What I can help you with. </h1>
                <div className="mt-10 md:mt-20 flex flex-col items-center">
                    <div className="w-full md:w-1/2 h-auto flex gap-10 flex-wrap mb-32">
